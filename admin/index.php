      ...
      <div class="main-panel">
        ...
        <div class="row">
              ...
              <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                  ...
                  <div class="d-flex justify-content-between align-items-end flex-wrap">
                      <!-- <a href="import2.php" class="btn btn-primary mt-2 mt-xl-0">Import</a> &nbsp;&nbsp; -->
                        <a href="export.php" class="btn btn-primary mt-2 mt-xl-0">Download</a>
                </div>
          ...
          <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Appointment Enquiry Data</h4>
                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="py-3">
                            <?php echo $m["study_destination"];?>
                          </td>
                          
                            <td class="py-3">
                            <?php echo $m["utm_source"];?>
                          </td>
                            <td class="py-3">
                            <?php echo $m["utm_medium"];?>
                          </td>
                            <td class="py-3">
                            <?php echo $m["utm_campaign"];?>
                          </td>
                            <td class="py-3">
                            <?php echo $m["utm_term"];?>
                          </td>
                            <td class="py-3">
                            <?php echo $m["utm_content"];?>
                          </td>
