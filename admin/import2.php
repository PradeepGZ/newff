                    ...
                    <div class="card">
                        <div class="card-body">
                           ...
                           <div class="col-md-8 offset-2">
                              ...
                              <form action="file-upload.php" id="import_excel_form" method="post" enctype="multipart/form-data">

                                <div class="form-group row">
                                  <label class="col-md-3">Select File</label>
                                  <div class="col-md-8">
                                <input type="file" name="uploadfile" ID="fileSelect" class="form-control"  accept=".xlsx, .xls, .csv" required/>
                                </div>
                                </div>
