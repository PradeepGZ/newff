            ...
            <div class="content-wrapper">
                    ...
                    <div class="col-md-12 grid-margin">
                        <div class="d-flex justify-content-between flex-wrap">
                            ...
                            <div class="d-flex justify-content-between align-items-end flex-wrap">
                                <a href="contactExport.php" class="btn btn-primary mt-2 mt-xl-0">Download</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                      ...
                      <tbody>
                        <?php foreach($contact as $m) :?>
                        <tr>
                          <td class="py-3">
                            <?php echo $m["cname"];?>
                          </td>
                          <td class="py-3">
                            <?php echo $m["cemail_id"];?>
                          </td>
                          <td class="py-3">
                            <?php echo $m["cphoneno"];?>
                          </td>
                          ...
                          <td class="py-3">
                            <?php echo $m["cstudy_destination"];?>
                          </td>
                          
                            <td class="py-3">
                            <?php echo $m["cutm_source"];?>
                          </td>
                            <td class="py-3">
                            <?php echo $m["cutm_medium"];?>
                          </td>
                            <td class="py-3">
                            <?php echo $m["cutm_campaign"];?>
                          </td>
                            <td class="py-3">
                            <?php echo $m["cutm_term"];?>
                          </td>
                            <td class="py-3">
                            <?php echo $m["cutm_content"];?>
                          </td>
